                  ...
                  <div className="container">
                    <div className="upcoming_box">
                      <div className="upcoming_card">
                        ...
                        >
                          Butun oila uchun mukammal
                          qulayliklarga ega xonadonlar
                        </h3>
                        <p className="slidet_text2">
                          Crystal Avenue — TXT Group kompaniyasi tomonidan Fargʻona shahrida barpo
                          etilayotgan koʻp qavatli, komfort toifadagi turar-joy majmuasi.
                        </p>
                      </div>
